...
elFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:B.dataSeries.dataPointEOs[B.index].cumulativeSum}):s(this.options.label)?da(s(c)?B.dataSeries.dataPointEOs[B.index].cumulativeSum:c,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=B.dataSeries.dataPointEOs[B.index].cumulativeSum):(v=1===q.lineWidth%2?(s(a)?d:this.parent.convertValueToPixel(B.dataPoint.y)<<
